    ...
    for p in (avList['services'] + avList['capabilities']):
        ...
        try:
            if (pId in maps.service_list):
                ...
                merged_services[pId]['azure-public']['available']           = (len(p['azure-public']['ga'])>0)
                merged_services[pId]['azure-public']['preview']             = list(p['azure-public']['preview'])
                merged_services[pId]['azure-public']['planned-active']      = list(p['azure-public']['planned-active'])

                merged_services[pId]['azure-government']['ga']              = list(p['azure-government']['ga'])
                merged_services[pId]['azure-government']['available']       = (len(p['azure-government']['ga'])>0)
                merged_services[pId]['azure-government']['preview']         = list(p['azure-government']['preview'])
                merged_services[pId]['azure-government']['planned-active']  = list(p['azure-government']['planned-active'])

            elif (pId in maps.capability_list):
                merged_capabilities[pId]['categories']                          = list(p['categories'])

                merged_capabilities[pId]['azure-public']['ga']                  = list(p['azure-public']['ga'])
                merged_capabilities[pId]['azure-public']['available']           = (len(p['azure-public']['ga'])>0)
                merged_capabilities[pId]['azure-public']['preview']             = list(p['azure-public']['preview'])
                merged_capabilities[pId]['azure-public']['planned-active']      = list(p['azure-public']['planned-active'])

                merged_capabilities[pId]['azure-government']['ga']              = list(p['azure-government']['ga'])
                merged_capabilities[pId]['azure-government']['available']       = (len(p['azure-government']['ga'])>0)
                merged_capabilities[pId]['azure-government']['preview']         = list(p['azure-government']['preview'])
                merged_capabilities[pId]['azure-government']['planned-active']  = list(p['azure-government']['planned-active'])
    ...
    for pId, p in scList.items():
        ...
        try:
            ...
            if (pId in maps.service_list and "azure-public" in p and len(p['azure-public']['scopes']) >0 ):
                merged_services[pId]['azure-public']['scopes'] = list(p['azure-public']['scopes'])
            if (pId in maps.service_list and "azure-government" in p and len(p['azure-government']['scopes'])>0):               
                merged_services[pId]['azure-government']['scopes'] = list(p['azure-government']['scopes'])
                
            if (pId in maps.capability_list and "azure-public" in p and len(p['azure-public']['scopes'])>0):
                merged_capabilities[pId]['azure-public']['scopes'] = list(p['azure-public']['scopes'])
            if (pId in maps.capability_list and "azure-government" in p and len(p['azure-government']['scopes'])>0):   
                merged_capabilities[pId]['azure-government']['scopes'] = list(p['azure-government']['scopes'])
